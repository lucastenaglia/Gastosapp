  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isRegistering) {
        ...
        console.log('🔐 Login - Usuario creado:', user)
        console.log('🔐 Login - Usuario creado - id:', user?.id)
        console.log('🔐 Login - Usuario creado - id tipo:', typeof user?.id)
      } else {
        console.log('🔐 Login - Intentando login...')
        user = await validateCredentials(email, password)
        console.log('🔐 Login - Usuario validado:', user)
        console.log('🔐 Login - Usuario validado - id:', user?.id)
        console.log('🔐 Login - Usuario validado - id tipo:', typeof user?.id)
      }
      
      if (user && user.id) {
        console.log('🔐 Login - Usuario válido, guardando en localStorage...')
        console.log('🔐 Login - Usuario a guardar:', user)
        localStorage.setItem('user', JSON.stringify(user))
        onLogin(user)
      } else {
        console.error('❌ Login - Usuario inválido o sin id')
        console.error('❌ Login - Usuario recibido:', user)
