  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div 
          className="bg-gradient-to-r from-amber-400 to-orange-500 p-3 sm:p-4 rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 cursor-pointer col-span-2 sm:col-span-1"
