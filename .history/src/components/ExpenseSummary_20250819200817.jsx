  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        {/* Total de Gastos */}
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer pt-5 sm:pt-3">
          <div className="space-y-2">
            <p className="text-sm font-medium text-gray-600">Total Gastos</p>
            <div className="flex items-end sm:items-center justify-between">
              <p className="text-2xl sm:text-lg lg:text-xl font-bold text-gray-900 self-end sm:self-auto">
                {expenses.length}
              </p>
              <div className="bg-purple-100 p-2 rounded-lg self-end sm:self-auto">
