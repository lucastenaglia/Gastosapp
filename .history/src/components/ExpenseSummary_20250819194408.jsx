...
const ExpenseSummary = ({ expenses, isPersonal = false, householdMembers = [], onFilterPerson = null, categories = [] }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {!isPersonal && (
        <>
          {/* Primera fila - Usuarios del hogar (siempre 2 en la misma línea en móvil, adaptativo en escritorio) */}
          ...
          {/* Segunda fila - Tercer usuario y/o Auto (adaptativo en escritorio) */}
