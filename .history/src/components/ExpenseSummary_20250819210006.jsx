  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        {/* Cafesito App - Botón de Donación */}
        <div className="bg-gradient-to-r from-amber-400 to-orange-500 p-3 sm:p-4 rounded-lg shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-200 cursor-pointer col-span-2 sm:col-span-1">
          <div className="space-y-2">
            <p className="text-sm font-medium text-white">¡Apoya el proyecto!</p>
            <div className="flex items-center justify-between">
              <div className="flex-1">
              ...
              <div className="bg-white/20 p-2 rounded-lg">
                <Coffee className="h-4 w-4 sm:h-5 sm:w-5 lg:h-8 lg:w-8 text-white" />
              </div>
            </div>
          </div>
        </div>
