    ...
    <div className="space-y-4">
      ...
      {!isPersonal && (
        <>
          ...
          {/* Segunda fila - Auto y/o tercer usuario - SIEMPRE 3 COLUMNAS EN ESCRITORIO */}
          {(personTotals.auto && personTotals.auto > 0) && (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4" style={{ gridTemplateColumns: 'repeat(3, 1fr)' }}>
              {/* Ticker de Auto */}
              <div 
                className="bg-white p-3 sm:p-4 rounded-lg shadow border hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer"
