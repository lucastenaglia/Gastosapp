...
const ExpenseStats = ({ expenses, onClose, isOpen, categories = [] }) => {
  ...
  // Generar colores dinámicamente para las categorías
  const generateCategoryColors = () => {
    ...
    const dynamicColors = [
      '#E74C3C', '#3498DB', '#2ECC71', '#9B59B6', '#F39C12', '#E67E22', '#1ABC9C', '#34495E',
      '#8E44AD', '#16A085', '#27AE60', '#D35400', '#C0392B', '#7F8C8D', '#2C3E50', '#E91E63'
    ]
  ...
  return (
    ...
    >
      <div 
        className="bg-white rounded-xl shadow-2xl max-w-4xl w-full mx-4 animate-in zoom-in-95 duration-200"
