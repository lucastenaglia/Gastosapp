        ...
        <>
          ...
          {(householdMembers.length > 2 || (personTotals.auto && personTotals.auto > 0)) && (
            <div className={`grid gap-3 sm:gap-4 ${
              // En escritorio: si hay 3 usuarios + Auto, solo mostrar usuarios (Auto va a la tercera fila)
              // En móvil: siempre mostrar todo en la misma fila
              householdMembers.length > 2 && (personTotals.auto && personTotals.auto > 0) 
              ...
              {/* Ticker de Auto (si existe y NO hay 3 usuarios + Auto en escritorio) */}
          ...
          {/* Tercera fila - Solo Auto cuando hay 3 usuarios + Auto (en escritorio) */}
          {householdMembers.length > 2 && (personTotals.auto && personTotals.auto > 0) && (
