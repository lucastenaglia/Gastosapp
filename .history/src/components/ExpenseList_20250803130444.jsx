  ...
  return (
    <div className="card">
      ...
      <div className="space-y-4">
                      ...
                      <div key={expense.id} className="border border-gray-200 rounded-lg p-4 bg-white shadow-md hover:shadow-xl hover:-translate-y-1 transform transition-all duration-300">
