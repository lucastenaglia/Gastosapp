    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
         ...
         <div className="card relative p-4 sm:p-6">
           ...
           <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 bg-blue-100 p-2 sm:p-3 rounded-lg shadow-lg">
         ...
         <div className="card relative p-4 sm:p-6">
           ...
           <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 bg-green-100 p-2 sm:p-3 rounded-lg shadow-lg">
         ...
         <div className="card relative p-4 sm:p-6">
           ...
           <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 bg-purple-100 p-2 sm:p-3 rounded-lg shadow-lg">
         ...
         <div className="card relative p-4 sm:p-6">
           ...
           <div className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 bg-orange-100 p-2 sm:p-3 rounded-lg shadow-lg">
           ...
           <div>
             ...
             <p className="text-sm text-gray-600">
               {totalExpenses > 0 ? `${((lucasTotal / totalExpenses) * 100).toFixed(1)}%` : '0%'} del total
                       ...
                       <div className="absolute bottom-3 right-3 bg-blue-100 p-3 rounded-lg shadow-lg">
           ...
           <div>
             ...
             <p className="text-sm text-gray-600">
               {totalExpenses > 0 ? `${((aldiTotal / totalExpenses) * 100).toFixed(1)}%` : '0%'} del total
                       ...
                       <div className="absolute bottom-3 right-3 bg-pink-100 p-3 rounded-lg shadow-lg">
              <span className="text-2xl">👩</span>
            </div>
         </div>
      </div>
