...
const ExpenseSummary = ({ expenses, isPersonal = false, householdMembers = [], onFilterPerson = null, categories = [] }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-1 sm:gap-3 lg:gap-4">
        {/* Total General */}
        <div className="bg-white p-1 sm:p-3 lg:p-4 rounded-lg shadow border hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer">
      ...
      {!isPersonal && (
        <>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-3 gap-1 sm:gap-3 lg:gap-4">
            {/* Primer usuario */}
            {householdMembers.slice(0, 1).map((member, index) => {
              ...
              return (
                <div 
                  key={member.user_id} 
                  className="bg-white p-1 sm:p-3 lg:p-4 rounded-lg shadow border hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer"
            ...
            {(personTotals.auto && personTotals.auto > 0) && (
              <div 
                className="bg-white p-1 sm:p-3 lg:p-4 rounded-lg shadow border hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer col-span-2 lg:col-span-1"
