      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div className="bg-white p-3 sm:p-4 rounded-lg shadow border hover:shadow-lg hover:scale-105 transition-all duration-200 cursor-pointer">
          <div className="space-y-2">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between items-end">
              <p className="text-2xl sm:text-lg lg:text-xl font-bold text-gray-900 order-2 sm:order-1">
                {expenses.length}
              </p>
              <div className="bg-purple-100 p-2 rounded-lg self-end sm:self-auto order-1 sm:order-2">
