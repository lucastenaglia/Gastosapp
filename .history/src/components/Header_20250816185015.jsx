import { Plus, DollarSign, Home, Settings, LogOut, ArrowLeft } from 'lucide-react'

const Header = ({ onAddExpense, onLogout, user, household, onSetupHousehold, onLeaveHousehold, onReturnToHousehold }) => {
  return (
          ...
          <div className="flex items-center space-x-3">
            ...
            {!household && onReturnToHousehold && (
              ...
              >
                ...
                <span className="text-sm hidden sm:inline">Volver al Hogar</span>
              </button>
            )}
            ...
            {household && onLeaveHousehold && (
              <button
                ...
                title="Salir del hogar y volver a modo personal"
              >
