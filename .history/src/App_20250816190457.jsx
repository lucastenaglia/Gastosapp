        ...
        <div className="mb-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <p className="text-sm text-blue-700">
                Actualmente estás viendo tus gastos personales. Puedes crear un hogar compartido o unirte a uno existente.
              </p>
            </div>
            <button
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <div className="bg-white p-3 rounded border">
              <h4 className="font-medium text-gray-900 mb-2">🔧 Debug - Gastos Personales</h4>
              <button
                onClick={() => {
            ...
            <div className="bg-white p-3 rounded border">
              <h4 className="font-medium text-gray-900 mb-2">🔧 Debug - Test Directo</h4>
              <button
                onClick={async () => {
