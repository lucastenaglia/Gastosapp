...
export const getPersonalExpenses = async (userId) => {
  try {
    ...
    // Solo obtener gastos realmente personales (sin hogar)
    console.log('🔍 Ejecutando consulta para gastos personales (household_id = null)...')
    ...
    console.log('📊 Gastos personales finales a retornar:', personalExpenses)
